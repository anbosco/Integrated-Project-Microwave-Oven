%% This function plot the results for the 1D wave propagation in a homogeneous
% medium
...
%% Importation
%% Ey
load('Cut_Ey_alongX_step25_rank0.txt');
load('Cut_Ey_alongX_step25_rank4.txt');
y1_Ey = [Cut_Ey_alongX_step25_rank0; Cut_Ey_alongX_step25_rank4];

load('Cut_Ey_alongX_step50_rank0.txt');
load('Cut_Ey_alongX_step50_rank4.txt');
y2_Ey = [Cut_Ey_alongX_step50_rank0; Cut_Ey_alongX_step50_rank4];

load('Cut_Ey_alongX_step75_rank0.txt');
load('Cut_Ey_alongX_step75_rank4.txt');
y3_Ey = [Cut_Ey_alongX_step75_rank0; Cut_Ey_alongX_step75_rank4];

load('Cut_Ey_alongX_step100_rank0.txt');
load('Cut_Ey_alongX_step100_rank4.txt');
y4_Ey = [Cut_Ey_alongX_step100_rank0; Cut_Ey_alongX_step100_rank4];

load('Cut_Ey_alongX_step150_rank0.txt');
load('Cut_Ey_alongX_step150_rank4.txt');
y5_Ey = [Cut_Ey_alongX_step150_rank0; Cut_Ey_alongX_step150_rank4];
...
plot([0.525 0.525], [-150 150],'k-.','linewidth',2)
plot([0.075 0.075], [-150 150],'k-.','linewidth',2)
xlabel('$x [m]$');
ylabel('$E_y [V\cdot m^{-1}]$');
ylim([-150 150]);
box on;
