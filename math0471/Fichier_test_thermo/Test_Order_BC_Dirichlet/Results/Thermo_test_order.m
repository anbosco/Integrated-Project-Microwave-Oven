...
% 1D problem with Dirichlet boundary conditions.
...
plot([0 L],[sin((L/2)*(pi/L))*(L/pi)^2*Q + (50/L)*(L/2) sin((L/2)*(pi/L))*(L/pi)^2*Q + (50/L)*(L/2)],'k','linewidth',4);
xlabel('$y [m]$');
ylabel('Temperature [°C]');
